...
try:
    ...
    (OUT/'e2e.json').write_text(json.dumps({'environment':'Chromium synthetic harness; not Windows WebView2 or a real account','results':results},ensure_ascii=False,indent=2))
